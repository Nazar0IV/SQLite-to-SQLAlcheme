...
def login():
    if request.method == "POST":
        if request.form['user'] == "admin" and request.form['psw'] == "12345":
            login_admin()
            return redirect(url_for('.index'))  #'.index'=='admin.index', здеcь 'admin'-имя BluePrint -1-й аргумент у экземпляра класса из текущего каталога индекс, без точки - из корневого, основная главная станица
        else:
